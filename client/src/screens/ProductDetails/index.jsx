          ...
          <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
            ...
            <div className="lg:col-span-5">
              ...
              <button
                ...
                className="focus:outline-none focus:ring-2 mt-8 flex w-full items-center cursor-poiter justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white transition-all hover:bg-indigo-700"
              >
                Add to Cart
              </button>
