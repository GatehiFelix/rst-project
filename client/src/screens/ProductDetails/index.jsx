						...
						<div className='lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8'>
							...
							<div className='lg:col-span-5 lg:col-start-8'>
								...
								<button
									...
									className='foucs:outline-none foucs:ring-2 mt-8 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white transition-all hover:bg-indigo-700 cursor-pointer'>
									Add to cart
								</button>
